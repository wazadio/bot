...
class Config:
    ...
    def load_from_env(self) -> None:
        ...
        self.database_host = os.getenv("DATABASE_HOST", "77.37.125.213")
        self.database_port = int(os.getenv("DATABASE_PORT", 1433))
        self.database_name = os.getenv("DATABASE_NAME", "AlphaPlus")
        self.database_user = os.getenv("DATABASE_USER", "sa")
        self.database_password = os.getenv("DATABASE_PASSWORD", "N@n0Gen4%X")
        self.environment = os.getenv("ENVIRONMENT", "development")
        self.telegram_group_id = int(os.getenv("TELEGRAM_GROUP_ID", "-4950698426"))